    ...
    <div>
        <template v-if="!unSetMiBao">
            <div class="serverQue">
                ...
                <van-field v-model="serverQue_ans" placeholder="输入密保1答案(长度小于25)" type="text" required clearable/>
        ...
        <template v-else>
            ...
            <div class="que_wrap">
                <p><span class="red">*必填</span> 问题1：</p>
            ...
            <div class="que_wrap">
                <p><span class="red">*必填</span> 问题2：</p>
                <van-dropdown-menu :overlay="false">
...
<script>
import { setsequestion, checksequestion } from '../../../Api/api'
            ...
            if(flag){
                ...
                checksequestion(params).then(res => {
                    if (res.msg == '您尚未设置密保') {
                        console.log('1');
                        this.unSetMiBao = true
                    }else if(res.msg == '操作成功'&&res.data['ques_num']!=undefined){
                        console.log('2');
