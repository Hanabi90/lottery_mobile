    ...
    <div class="usercenter">
        ...
        <van-popup :class="[{ovh:navlist[0].active},'pop_right']" @closed="closePop" v-model="show" :overlay="false" position="right">
            ...
            <div class="popwrap">
                ...
                <huodongguanli v-else-if="navlist[7].active"></huodongguanli>
                <!-- ="navlist[9].active" -->
            </div>
        </van-popup>
    </div>
...
import bank from '../usercenter/bank.vue'
import bethistory from '../usercenter/bethistory'
import zhuihaoHistory from '../usercenter/zhuihaoHistory'
import myHeader from '../usercenter/header'
import orderhistory from '../usercenter/orderhistory'
import Feiyouxizhangbian from '../usercenter/Feiyouxizhangbian'
import accountSet from '../usercenter/accountSet'
import Notice from '../usercenter/Notice'
import huodongguanli from '../usercenter/huodongguanli'
import quickHistory from '../pk10/quickHistory'
...
export default {
    ...
    methods: {
        ...
        tabNav(index, event) {
            ...
            this.$router.push({name:this.navlist[index].title})
            // switch (index) {
            //     case 0:
