    ...
    <div id="home">
        ...
        <div class="banner">
            ...
            <van-swipe :autoplay="3000" indicator-color="white">
                <van-swipe-item v-for="(imgUrl, index) in swiperImgs" :key="imgUrl">
                    <van-image width="100%" height="187.5px" fit="cover" :src="imgUrl"/>
                </van-swipe-item>
            </van-swipe>
            <div class="marquee">
                <div class="box">
        ...
        <Popup ref="popup" @closed="fixPop" class="popup" v-model="show" position="bottom">
            <div class="form">
                <form>
                    ...
                    <div class="form_ctl">
                        <label class="label">
                            <i
                                :class="[{'active':isCheckBoxActive},'form_ckeckbox']"
                                @click="rememberInfo"
                            >
            ...
            <div class="login_foot">
                没有账号？
                <router-link to="/register">请新建一个账号</router-link>
            </div>
        </Popup>
    </div>
</template>
